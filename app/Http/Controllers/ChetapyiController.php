...
class ChetapyiController extends Controller
{
    ...
    public function generateDocx($id,$tipo)
    {
        ...
        $word->Documents->Open(storage_path("/chetapyi/impresion/".$CerNro.".docx"));
        // save it as word 2003
        //$word->ActiveDocument->SaveAs('newdocument.doc');
        // convert word 2007-2013 to PDF
        $word->ActiveDocument->ExportAsFixedFormat(storage_path("/chetapyi/impresion/".$ext.substr(rtrim($postulante->CerNro), 5).'_'.$CerNro.".pdf"), 17, false, 0, 0, 0, 0, 7, true, true, 2, true, true, false);
