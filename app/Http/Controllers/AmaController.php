...
class AmaController extends Controller
{
    ...
    public function generateDocx($id,$tipo)
    {
        ...
        $templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor(storage_path('/ama/template/amatemplate.docx'));
        ...
        //Cedula
        $templateProcessor->setValue('CAMPO26', trim($postulante->CerNro));
        ...
        $templateProcessor->saveAs(storage_path("/ama/impresion/".trim($postulante->CerNro).".docx"));
        ...
        $word->Documents->Open(storage_path("/ama/impresion/".trim($postulante->CerNro).".docx"));
        // save it as word 2003
        //$word->ActiveDocument->SaveAs('newdocument.doc');
        // convert word 2007-2013 to PDF
        $word->ActiveDocument->ExportAsFixedFormat(storage_path("/ama/impresion/".trim($postulante->CerNro).".pdf"), 17, false, 0, 0, 0, 0, 7, true, true, 2, true, true, false);
